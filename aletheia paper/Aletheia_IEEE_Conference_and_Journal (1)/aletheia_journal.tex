...
\author{Joseph~Walusimbi$^{*}$,
  Ann~Move~Oguti,
  Abubakhari~Sserwadda,
  Precious~Boss~Kasasira,
  and~Charles~Brian~Okoboi
...
Soroti, Uganda. $^{*}$Corresponding author: J. Walusimbi
(e-mail: 2401600068@sun.ac.ug). A. M. Oguti (e-mail: amoguti@sun.ac.ug).
A. Sserwadda (e-mail: asserwadda@sun.ac.ug).}
